...
public class BankManagementServiceIT {
    ...
    public void activateAccount() {
        ...
        Optional<BankAccountDto> result = accountService.getAccountInfo("franklin.benjamin@gmail.com");
    ...
    public void deactivateAccount() {
        ...
        Optional<BankAccountDto> result = accountService.getAccountInfo("theodore.roosevelt@gmail.com");
    ...
    public void makeDeposit_measureTime() {
        Assertions.assertTimeout(Duration.ofMillis(60), () -> service.makeDeposit("theodore.roosevelt@gmail.com", 50));
    }
